// PROTOTYPE, throwaway: brings a freshly started measuring window (DevTools port 9223) to where the checks start:
// recorder and pings installed, a Recording open, SourceTrack 5 cutting with the Gaming preset, cut.
//   node bench/prototype-jpeg-picture/setup.mjs ["<Recording>"] [--no-cut]
...
console.log("recorder", await run(readFileSync(new URL("../webcodecs-picture-diagnosis/recorder.js", here), "utf8")));
